...
func (kpm *KeyPressMap) SumMoveDxDy(
	key2dir map[string]direction.Direction_Type) (int, int) {
...
/* SumMoveDxDy example
var Key2Dir = map[string]direction.Direction_Type{
	"End":        direction.Dir_sw,
	"ArrowDown":  direction.Dir_s,
	"PageDown":   direction.Dir_se,
	"ArrowLeft":  direction.Dir_w,
	"Clear":      direction.Dir_stop,
	"ArrowRight": direction.Dir_e,
	"Home":       direction.Dir_nw,
	"ArrowUp":    direction.Dir_n,
	"PageUp":     direction.Dir_ne,
}
*/
